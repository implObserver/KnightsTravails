...
const setListenersForDemo = () => {
    window.removeEventListener('resize', hideArrow());
    window.addEventListener('click', (0,_models_lernPreset__WEBPACK_IMPORTED_MODULE_1__.demoSteps)().step1, { once: true, passive: false })
...
const setListenersForDemoForMibile = () => {
    window.addEventListener('mousedown', (0,_models_lernPreset__WEBPACK_IMPORTED_MODULE_1__.demoSteps)().step1, { once: true, passive: false })
